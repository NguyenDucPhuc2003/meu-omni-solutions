...
[RequireRole("Admin")]
[Route("api/modules/reporting/reports/dashboard")]
...
{
    [RequirePermission(PermissionCodes.Reports.Dashboard.Read)]
    [HttpGet]
    public IActionResult GetAll(CancellationToken cancellationToken)
    {
        return Ok(new
        {
            scaffold = true,
            module = "Reporting",
            resource = ReportingScaffoldCatalog.GetResource("Dashboard"),
